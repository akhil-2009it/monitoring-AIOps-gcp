"""Vertex CustomJob entrypoint — RCF on metrics.

Note: GCP has no managed RCF container. We approximate with sklearn
IsolationForest (very close behaviour for unsupervised tabular AD), then
serve via Vertex Endpoint with a small custom predictor.
"""
